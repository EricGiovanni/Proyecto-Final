...
<html>
	...
	<body>
		<br/><div class = "container">
				...
				<div class="row">
					<form action = "Rgcoord.php" method = "POST">
						<p><label style = "color:White;" for="user">Usuario:</label><br/><input type = "text" id="user" name = "Usuario" placeholder = "Usuario" pattern = "[A-z0-9]{5,}" class = "form-control-static" required></p><br/>
